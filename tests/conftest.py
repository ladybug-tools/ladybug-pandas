...
# @pytest.fixture
# def dbt_array(dtype_class):
#     return LadybugArrayFactory(dtype_class)
...
def data(dbt_data_collection, dtype):
    ...
    * data[0] and data[1] should not be equal
    ...
    return LadybugArrayType(values, dtype)
...
def data_missing(dtype):
    ...
    return LadybugArrayType([np.nan, 3.4], dtype)
...
def data_for_sorting(dtype):
    ...
    A < B < C
    """
    return LadybugArrayType([5, 10, 2], dtype)
...
def data_missing_for_sorting(dtype):
    ...
    A < B and NA missing.
    """
    return LadybugArrayType([5, None, 2], dtype)
...
def data_for_grouping(dtype):
    ...
    """
    return LadybugArrayType([3, 3, None, None, 1, 1, 3, 5], dtype)
